...
import 'package:eventique_shreek/widgets/order_tile.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';


 final List<ServiceInOrderDetails> orders=[
    ServiceInOrderDetails(dueDate: DateTime.now(),imgUrl: 'dd',isCustomized: 1,name: 'test',orderServiceId:1,orederdBy:'lala',quantity: 43,status: 'pending',totalPrice: 53),
    ServiceInOrderDetails(dueDate: DateTime.now(),imgUrl: 'ss',isCustomized: 0,name: 'rse',orderServiceId:2,orederdBy:'lalalo',quantity: 43,status: 'pending',totalPrice: 53),
...
class OrdersScreen extends StatelessWidget {
  ...
  Widget buildOrderList(List<ServiceInOrderDetails> orders, BuildContext context,int? fromProcessed) {
